...
Bus.prototype.send = notImplemented.bind('send');
Bus.prototype.listen = notImplemented.bind('listen');
Bus.prototype.publish = notImplemented.bind('publish');
Bus.prototype.subscribe = notImplemented.bind('subscribe');

function notImplemented (method) {
  throw new Error(`method ${method} is not implemented in ${this.type}.`)
};
